...
const Weather = () => {
  ...
  return (
    <div style={{width:'400px', height: '168px'}}>
      <WeatherBox>
        <TextBox>
          <div>
            <p>{DateText}</p>
